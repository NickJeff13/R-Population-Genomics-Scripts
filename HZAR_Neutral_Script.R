...
crabneutral<-read.table("Crab_HZAROutliersIn.txt",header=TRUE)
#print(samout)

rm(i)
rm(neutral)
if(length(apropos("^neutral$",ignore.case=FALSE)) == 0 ||
   + !is.list(neutral) ) neutral <- list()
...
for(i in 1:100){
  ...
  locusname=colnames(crabneutral)[i+2]
  locusnumber=colnames(crabneutral)[i+102]
  
  png(width=900, height=900, res=200, family="Arial", filename=paste0(locusname,"clinePlot.png"),pointsize=8)
  
  ## good to stay organized.
  neutral$locus <- list();
  neutral$locus$obs <- list();
  ## Space to hold the models to fit
  neutral$locus$models <- list();
  ## Space to hold the compiled fit requests
  neutral$locus$fitRs <- list();
  ## Space to hold the output data chains
  neutral$locus$runs <- list();
  ## Space to hold the analysed data
  neutral$locus$analysis <- list();
  
  neutral$locus$obs <- hzar.doMolecularData1DPops(crabneutral$Distance,
                                                  crabneutral[,locusname],
                                                  crabneutral[,locusnumber])
  #Plot the data (this will plot all your loci as separate pngs)
  hzar.plot.obsData(neutral$locus$obs)
  
  #####Make your models (4 models per locus)#####
  #neutral$locus$models$model1 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
  #                                                                scaling="fixed", tails="none")
  #neutral$locus$models$model2 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
  #                                                                scaling="fixed", tails="both")
  #neutral$locus$models$model3 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
  #                                                                scaling="free", tails="none")
  #neutral$locus$models$model4 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
  ...
  neutral$locus$models$model4 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
                                                      scaling = "free",tails="both")
  neutral$locus$models$model5 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
                                                      scaling="fixed", tails="none")
  neutral$locus$models$model6 <- hzar.makeCline1DFreq(data=neutral$locus$obs, 
                                                      scaling="fixed", tails="both")
  
  print(neutral$locus$models)
  
  #data collected between 0 and 5100km
  neutral$locus$models <- sapply(neutral$locus$models, hzar.model.addBoxReq,
  ...
  neutral$locus$fitRs$init <- sapply(neutral$locus$models, 
                                     hzar.first.fitRequest.old.ML,
                                     obsData = neutral$locus$obs,
                                     verbose=FALSE,
                                     simplify=FALSE)
  #update settings for the fitter using chainLength and mainSeed created before
  neutral$locus$fitRs$init$model1$mcmcParam$chainLength <- chainLength
  neutral$locus$fitRs$init$model1$mcmcParam$burnin <- chainLength %/% 10
  neutral$locus$fitRs$init$model1$mcmcParam$seed[[1]] <- mainSeed$A
  
  neutral$locus$fitRs$init$model2$mcmcParam$chainLength <- chainLength
  neutral$locus$fitRs$init$model2$mcmcParam$burnin <- chainLength %/% 10
  neutral$locus$fitRs$init$model2$mcmcParam$seed[[1]] <- mainSeed$B
  
  neutral$locus$fitRs$init$model3$mcmcParam$chainLength <- chainLength
  neutral$locus$fitRs$init$model3$mcmcParam$burnin <- chainLength %/% 10
  neutral$locus$fitRs$init$model3$mcmcParam$seed[[1]] <- mainSeed$C
  
  neutral$locus$fitRs$init$model4$mcmcParam$chainLength <- chainLength
  neutral$locus$fitRs$init$model4$mcmcParam$burnin <- chainLength %/% 10
  neutral$locus$fitRs$init$model4$mcmcParam$seed[[1]] <- mainSeed$D
  
  neutral$locus$fitRs$init$model5$mcmcParam$chainLength <- chainLength
  neutral$locus$fitRs$init$model5$mcmcParam$burnin <- chainLength %/% 10
  neutral$locus$fitRs$init$model5$mcmcParam$seed[[1]] <- mainSeed$E
  
  neutral$locus$fitRs$init$model6$mcmcParam$chainLength <- chainLength
  neutral$locus$fitRs$init$model6$mcmcParam$burnin <- chainLength %/% 10
  neutral$locus$fitRs$init$model6$mcmcParam$seed[[1]] <- mainSeed$G
  
  #check fit request settings 
  print(neutral$locus$fitRs$init)
  
  #Run one model, just to check
  #neutral$locus$runs$init <- list()
  #neutral$locus$runs$init$model1 <-hzar.doFit(neutral$locus$fitRs$init$model1)
  #plot(hzar.mcmc.bindLL(neutral$locus$runs$init$model1))
  
  #Compile a new set of fit requests using the initial chains
  neutral$locus$fitRs$chains <- lapply(neutral$locus$init, 
  ...
  neutral$locus$fitRs$chains <- hzar.multiFitRequest(neutral$locus$fitRs$init,
                                                     each=3,
                                                     baseSeed=NULL)
  ...
  neutral$locus$runs$doSeq <- lapply(neutral$locus$fitRs$chains,
                                     hzar.chain.doSeq, 
                                     count = 3)
  
  names(neutral)[i]=locusname
...
print(outlier$ESTNV_13012_403$analysis$AICcTable)

#print the min AICc score
print(min(outlier$ESTNV_13012_403$analysis$AICcTable$AICc))
...
####Save data image####
save.image("~/Desktop/Nick/AtlanticSalmon/HZAR/EuropeOutliers.RData")
